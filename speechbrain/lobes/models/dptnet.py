...
class DPTNetBlock(nn.Module):
    ...
    def __init__(
        self, in_dim, d_model, nhead, dim_feedforward=256, dropout=0, activation="relu"
    ):
        ...
        self.rnn = LSTM(in_dim, d_model, 1, bidirectional=True)
        self.dropout = Dropout(dropout)
        # self.linear2 = Linear(dim_feedforward, d_model)
        self.linear2 = Linear(d_model * 2, in_dim)
