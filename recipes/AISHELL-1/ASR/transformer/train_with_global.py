...
class ASR(sb.core.Brain):
        ...
        if stage == sb.Stage.TRAIN:
            ...
            if current_epoch % self.hparams.valid_search_interval == 0:
                ...
                hyps, _ = self.hparams.valid_search(
                    enc_out.detach(), wav_lens, global_weight
                )
    ...
    def on_stage_end(self, stage, stage_loss, epoch):
        ...
        if stage == sb.Stage.TRAIN:
            ...
            if sb.utils.distributed.if_main_process():
                if self.distributed_launch:
                    self.modules.Transformer.module.update_global_scores()
                else:
                    self.modules.Transformer.update_global_scores()
        ...
        if sb.utils.distributed.if_main_process():
            if self.distributed_launch:
                self.modules.Transformer.module.clean_up()
            else:
                self.modules.Transformer.clean_up()
