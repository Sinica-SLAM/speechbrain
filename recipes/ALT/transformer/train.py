...
class ASR(sb.core.Brain):
    ...
    def on_stage_end(self, stage, stage_loss, epoch):
        ...
        if stage == sb.Stage.VALID and sb.utils.distributed.if_main_process():
            ...
            with open(self.hparams.cer_file, "w") as w_cer:
                self.cer_metric.write_stats(w_cer)
            
            with open(self.hparams.wer_file, "w") as w_wer:
                self.wer_metric.write_stats(w_wer)
...
def dataio_prepare(hparams):
    ...
    train_data = sb.dataio.dataset.DynamicItemDataset.from_csv(
        csv_path=hparams["train_csv"], replacements={"data_root": audio_data_folder},
    )
    ...
    valid_data = sb.dataio.dataset.DynamicItemDataset.from_csv(
        csv_path=hparams["valid_csv"], replacements={"data_root": audio_data_folder},
    )
...
if __name__ == "__main__":
    ...
    run_on_main(
        prepare_data,
        kwargs={
            "dali_folder": hparams["dali_folder"],
            "dali_v1_folder": hparams["dali_v1_folder"], 
            "dali_v2_folder": hparams["dali_v2_folder"], 
            "dali_audio_data_folder": hparams["dali_audio_data_folder"],
            "damp_audio_data_folder": hparams["damp_audio_data_folder"],
            "text_data_folder": hparams["text_data_folder"],
            "jamendo_folder": hparams["jamendo_folder"],
            "hansen_folder": hparams["hansen_folder"],
            "tr_splits": hparams["train_splits"],
            "dev_splits": hparams["dev_splits"],
            "te_splits": hparams["test_splits"],
            "benchmark_splits": hparams["benchmark_splits"],
